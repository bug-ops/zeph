...
CREATE TABLE durable_execution_integrity (
    ...
    max_committed_step_id   BIGINT NOT NULL,
    committed_result_count  BIGINT NOT NULL,
    hwm_hmac                BYTEA  NOT NULL,
...
ALTER TABLE durable_journal ADD COLUMN folded_count BIGINT;
