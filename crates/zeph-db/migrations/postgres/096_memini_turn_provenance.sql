...
ALTER TABLE graph_edges ADD COLUMN IF NOT EXISTS confidence_fast REAL NOT NULL DEFAULT 1.0;
ALTER TABLE graph_edges ADD COLUMN IF NOT EXISTS confidence_slow REAL NOT NULL DEFAULT 1.0;
ALTER TABLE graph_edges ADD COLUMN IF NOT EXISTS turn_index INTEGER;
