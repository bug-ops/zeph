...
pub struct AgentSessionConfig {
    ...
    pub category_config: crate::config::CategoryConfig,
    pub reasoning_config: zeph_config::ReasoningConfig,
    pub memcot_config: zeph_config::MemCotConfig,
    pub tree_config: crate::config::TreeConfig,
    ...
    /// Resume-visibility banner and `/history` bound settings (spec-068 §13, §18, #6420).
    pub resume: zeph_config::ResumeConfig,
...
impl AgentSessionConfig {
    ...
    pub fn from_config(config: &Config, budget_tokens: usize) -> Self {
        Self {
            ...
            reasoning_config: config.memory.reasoning.clone(),
            memcot_config: config.memory.memcot.clone(),
            tree_config: config.memory.tree.clone(),
            ...
            resume: config.session.resume.clone(),
