...
| `graph` | `GraphStore`, `Entity`, `Edge`, `Community`, `GraphFact`, `EntityType` — knowledge graph with BFS traversal, community detection via label propagation, and graph eviction (feature-gated: `graph-memory`) |
