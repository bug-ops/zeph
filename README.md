...
| **Task orchestration** | DAG-based task graphs with dependency tracking, parallel execution, configurable failure strategies (abort/retry/skip/ask), timeout enforcement, and SQLite persistence. Decompose complex goals into sub-agent tasks with automatic scheduling and result aggregation. Feature-gated: `orchestration`. [→ Orchestration](https://bug-ops.github.io/zeph/advanced/orchestration.html) |
