...
| **Context engineering** | Semantic skill selection, command-aware output filters, tool-pair summarization, reactive middle-out compaction, and proactive context compression keep the window efficient under any load. [→ Context](https://bug-ops.github.io/zeph/advanced/context.html) |
