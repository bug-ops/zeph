...
<div align="center">
  ...
  **A memory-first AI agent for long-running work — local, cloud, or decentralized.**
  ...
  [![Tests](https://img.shields.io/badge/tests-15761-brightgreen)](https://github.com/bug-ops/zeph/actions)
...
| **Sub-agents** | Spawning, grants, transcripts, live peer-to-peer messaging between running sub-agents (deny-by-default authorization, sanitized, no auto-injection into context). |
...
See [CONTRIBUTING.md](CONTRIBUTING.md), [CODE_OF_CONDUCT.md](CODE_OF_CONDUCT.md), and [SECURITY.md](SECURITY.md). Coverage-guided fuzzing harnesses for parser-like components live in [`fuzz/`](fuzz/README.md).
