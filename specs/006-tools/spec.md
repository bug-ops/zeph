# Spec: Tool Execution
## Sources
### External- **OWASP AI Agent Security Cheat Sheet** (2026) — shell sandbox and tool policy design: https://cheatsheetseries.owasp.org/cheatsheets/AI_Agent_Security_Cheat_Sheet.html
...
> **Status**: Implemented. Feature: `context-compression`.
...
> **Status**: Implemented. Closes #2414.
...
> **Status**: Implemented. Closes #2424.
...
> **Status**: Implemented. Feature: `policy-enforcer`. Closes #2447.
...
> **Status**: Implemented. Closes #2354.
...
> **Status**: Implemented. Closes #2354, #2356, #2357.
