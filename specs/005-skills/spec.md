# Spec: Skills System
## Sources
### External- SKILL.md format specification: https://agentskills.io/specification.md
...
Constraints:
- `disambiguation_threshold`: if top skill score < threshold, inject nothing. Default raised from 0.05 to **0.20** in v0.18.2 — previously the near-zero default caused near-irrelevant skills to be injected on almost every turn
- `min_injection_score`: minimum score a skill must achieve to be injected even when it clears the disambiguation threshold. Default 0.20. Added in v0.18.2 as a secondary quality gate independent of disambiguation
...
```toml
[skills]
disambiguation_threshold = 0.20   # v0.18.2 default (was 0.05); skip injection when top score below this
min_injection_score = 0.20        # v0.18.2; secondary quality gate for injection
...
- `disambiguation_threshold` check runs before any skill injection; default is 0.20 (raised from 0.05 in v0.18.2)
...
`crates/zeph-skills/src/trust_score.rs` and `crates/zeph-skills/src/scanner.rs`. Implemented in v0.18.0.
...
> **Status**: Implemented. Closes #2268.
...
> **Status**: Implemented. Closes #2600.
...
## Channel Allowlist
> **Status**: Implemented. Closes #2617.
...
> **Status**: Implemented. Closes #2418, #2605.
...
> **Status**: Implemented. Closes #2611.
