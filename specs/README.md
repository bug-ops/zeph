...
| Doc | Feature | Crate |
|---|---|---|
| `002-agent-loop/spec.md` | Agent loop, turn lifecycle, context pressure | `zeph-core` |
| `003-llm-providers/spec.md` | LlmProvider trait, AnyProvider, prompt caching | `zeph-llm` |
| `004-memory/spec.md` | SQLite + Qdrant, tool pair summarization, compaction | `zeph-memory` |
| `005-skills/spec.md` | SKILL.md format, registry, matching, hot-reload | `zeph-skills` |
| `006-tools/spec.md` | ToolExecutor, CompositeExecutor, audit, filtering | `zeph-tools` |
| `007-channels/spec.md` | Channel trait, AnyChannel dispatch, streaming | `zeph-channels` |
| `008-mcp/spec.md` | MCP client, server lifecycle, tool discovery | `zeph-mcp` |
| `009-orchestration/spec.md` | DAG planner, DagScheduler, AgentRouter, /plan | `zeph-core` |
...
| `012-graph-memory/spec.md` | Entity graph, BFS recall, community detection | `zeph-memory` |
...
| `015-self-learning/spec.md` | FeedbackDetector, Wilson score, trust model | `zeph-skills` |
